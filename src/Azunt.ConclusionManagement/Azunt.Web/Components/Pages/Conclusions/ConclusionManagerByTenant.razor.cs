...
using Azunt.Web.Components.Pages.Conclusions.Components;
...
public partial class ConclusionManagerByTenant : ComponentBase
{
    public ModalForm EditorFormReference { get; set; } = null!;
    public List<Conclusion> models = new();
    public Conclusion model = new();
    ...
    protected string DisplayConnectionString => string.IsNullOrWhiteSpace(TenantConnectionString)
        ...
        : TenantConnectionString.StartsWith(ConclusionAppDbContextFactory.InMemoryConnectionPrefix, StringComparison.OrdinalIgnoreCase)
    ...
    protected void EditBy(Conclusion m)
    {
    ...
    protected void DeleteBy(Conclusion m)
    {
        model = m;
    ...
    protected void ToggleBy(Conclusion m)
    {
        model = m;
    ...
    {
        Nav.NavigateTo("/api/ConclusionExport/ExcelByTenant", forceLoad: true);
    }
